...
from config.config_ollama import llama_model, hermes_model, phi_model  # Updated models
...
patient_experience_agent = Agent(
    ...
    llm=hermes_model,  # Use centralized Ollama LLM configuration
    inputs=["feedback"]
)
...
process_expert_agent = Agent(
    ...
    llm=llama_model,  # Use centralized Ollama LLM configuration
    inputs=["feedback"]
)
...
clinical_psychologist_agent = Agent(
    ...
    llm=phi_model,  # Use centralized Ollama LLM configuration
    inputs=["feedback"]
)
